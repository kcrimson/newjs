...
ifStatement returns [Statement result]
  :
  IF '(' expression ')' ifstatement=statement ('else' elsestatement=statement)? 
                                                                               {
...
forStatement returns [Statement result]
  :
  'for' '(' (forStatementInitialiserPart)? ';' (exp1=expression)? ';' (exp2=expression)? ')' statement 
                                                                                                      {
...
List expressions = new ArrayList();
  ...
  :
  exp1=assignmentExpression (',' exp2=assignmentExpression)? 
                                                            {
                                                             if ($exp2.result == null) {
                                                             	$result = $exp1.result;
                                                             } else
...
List expressions = new ArrayList();
  ...
  :
  exp1=assignmentExpressionNoIn (',' exp2=assignmentExpressionNoIn)*
  ;
/*
...
assignmentExpression returns [Expression result]
  ...
  | leftHandSideExpression assignmentOperator rightHandSideExpression=assignmentExpression 
                                                                                          {
...
assignmentExpressionNoIn returns [Expression result]
  ...
  | leftHandSideExpression assignmentOperator rightHandSideExpression=assignmentExpressionNoIn 
                                                                                              {
                                                                                               $result = new AssignmentExpression($leftHandSideExpression.result,
                                                                                               		$assignmentOperator.result, $rightHandSideExpression.result);
                                                                                              }
...
List<Expression> expresionSuffixes = new ArrayList<Expression>();
  ...
  (
    ...
    | 'new' exp=memberExpression arguments 
                                          {
...
conditionalExpression returns [Expression result]
  :
  logicalORExpression ('?' exp1=assignmentExpression ':' exp2=assignmentExpression)? 
                                                                                    {
...
conditionalExpressionNoIn returns [Expression result]
  :
  logicalORExpressionNoIn ('?' exp1=assignmentExpressionNoIn ':' exp2=assignmentExpressionNoIn)? 
                                                                                                {
                                                                                                 if ($exp1.result == null && $exp2.result == null) {
...
List values = new ArrayList();
  ...
  :
  '[' (firstExp=assignmentExpression 
                                    {
                                     values.add($firstExp.result);
                                    })? (',' (nextExp=assignmentExpression 
                                                                          {
...
List nameValuePairs = new ArrayList();
  ...
  :
  '{' (firstPair=propertyNameAndValue 
                                     {
                                      nameValuePairs.add($firstPair.result);
                                     }
    (',' nextPair=propertyNameAndValue 
                                      {
