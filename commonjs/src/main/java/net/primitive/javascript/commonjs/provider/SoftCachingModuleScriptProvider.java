 ...
 * @version $Id$
 */
public abstract class SoftCachingModuleScriptProvider extends CachingModuleScriptProviderBase {
	...
	public ModuleScript getModuleScript(Scope scope, String moduleId, URI uri, Scriptable paths) throws Exception {
		...
		return super.getModuleScript(scope, moduleId, uri, paths);
	}
	...
	protected void putLoadedModule(String moduleId, ModuleScript moduleScript, Object validator) {
		scripts.put(moduleId, new ScriptReference(moduleScript.getScript(), moduleId, moduleScript.getUri(), moduleScript.getBase(), validator, scriptRefQueue));
	}
